...
const VarStdSample = () => {
  return (
    <Stack maxWidth="2xl" margin="auto" padding={6}>
      ...
      <Image src="http://www.statisticslectures.com/images/samplevarstd.gif" />
      ...
      <Image src="http://www.statisticslectures.com/images/sampledefinitional.gif" />
      <Heading size="md" textAlign="center">
        Figure 2.
      </Heading>
      <Text>
      ...
      <Text>
        ...
        the total number of scores minus 1 to get a variance of 2.17.
      </Text>
      <Text>
        To get the standard deviation of this data set, all we need to do is
        take the square root of 2.17. After doing so, we find the standard
        deviation to be 1.47.
      </Text>
      <Text>
        Using the definitional formula can take a long time, so we usually use a
        shorter formula called the computational formula:
      </Text>
      <Image src="http://www.statisticslectures.com/images/samplecomputational.gif" />
      <Heading size="md" textAlign="center">
        Figure 3.
      </Heading>
      <Text>
      ...
      <Text>
        After plugging in all the values, we again find a variance of 2.17, and
        a standard deviation of 1.47.
      </Text>
      <Divider />
      <AspectRatio>
        <iframe
          src="https://www.youtube.com/embed/CtAwtH4WMN0"
          title="Variance and Standard Deviation of a Sample"
          allowFullScreen
        ></iframe>
      </AspectRatio>
    </Stack>
